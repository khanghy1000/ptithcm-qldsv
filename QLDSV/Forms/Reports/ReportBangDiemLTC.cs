...
namespace QLDSV.Forms.Reports {
    public partial class ReportBangDiemLTC : DevExpress.XtraReports.UI.XtraReport {
        public ReportBangDiemLTC() {
            InitializeComponent();
        }
        public ReportBangDiemLTC(string nienKhoa, int hocKy, int nhom, string maMonHoc) {
            InitializeComponent();
