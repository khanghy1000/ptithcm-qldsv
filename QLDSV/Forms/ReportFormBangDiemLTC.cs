...
namespace QLDSV.Forms {
    public partial class ReportFormBangDiemLTC : DevExpress.XtraEditors.XtraForm {
        public ReportFormBangDiemLTC() {
            InitializeComponent();
        }
        ...
        private void ReportFormBangDiemLTC_Load(object sender, EventArgs e) {
        ...
        private void btnPreview_Click(object sender, EventArgs e) {
            ...
            ReportBangDiemLTC report = new ReportBangDiemLTC(cmbNienKhoa.Text, int.Parse(cmbHocKy.Text),
